...
[CreateAssetMenu(menuName = "MiniPunBall/Enemy/MoveBoss")]
public class MoveBoss : MoveBehavior
{
  public override Vector2Int GetTargetCell(BoardObject boardObject)
  {
    var freeCell = LevelContext.Instance.BoardState.GetRandom2x2EmptyCell();
    if (freeCell != null)
    {
